...
<body>
		<div class="page-header">
			<h1><span class="text-light-gray">User Management / </span>Edit</h1>
		</div> <!-- / .page-header -->
...
-->
				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" id="jq-validation-form" action="${request.contextPath}/user-management/edit/${user.id}" method="post">
