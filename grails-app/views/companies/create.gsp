<html>
	<head>
		<title>New Company - Find Me A Job</title>
		<meta name="layout" content="loggedin" />
	</head>
<body>
		<div class="page-header">
			<h1><span class="text-light-gray">Companies / </span>New</h1>
		</div> <!-- / .page-header -->
...
-->
				...
				<div class="panel">
					<div class="panel-heading">
						<span class="panel-title">New Company</span>
					</div>
					<div class="panel-body">
						...
						<form class="form-horizontal" id="jq-validation-form" action="${request.contextPath}/companies/create" method="post">
